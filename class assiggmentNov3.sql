...
create schema class_assignment;
CREATE TABLE Worker (
...
CREATE TABLE Bonus (
	...
	FOREIGN KEY (WORKER_REF_ID)
        ...
        INSERT INTO Bonus (WORKER_REF_ID, BONUS_AMOUNT, BONUS_DATE) VALUES (001, 5000, '16-02-20'),(002, 3000, '16-06-11'),(003, 4000, '16-02-20'),
	(001, 4500, '16-02-20'),
		(002, 3500, '16-06-11');
	CREATE TABLE Title (
	WORKER_REF_ID INT,
...
Select FIRST_NAME as worker_name from Worker;
       ...
       select  count(worker_id) as numberofworkers,department from worker group by department order by count(worker_id) desc;

       select count(department) as numberOfEmployees,department from worker where department like '%Admin%';
      
       select w.worker_id, w.first_name, w.last_name, w.salary, w.JOINING_DATE, w.department, t.worker_title from worker w inner join title t on w.worker_id = t.worker_ref_id where t.WORKER_TITLE= 'Manager';